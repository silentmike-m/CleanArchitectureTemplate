namespace SilentMike.WebApi
{
    ...
    using Serilog;
    using SilentMike.Application;
    using SilentMike.Application.Common;
    using SilentMike.Infrastructure;
    using SilentMike.Infrastructure.HealthCheck.Extensions;
    using SilentMike.Infrastructure.HealthCheck.Models;
    using SilentMike.WebApi.Events;
    using SilentMike.WebApi.Extensions;
    using SilentMike.WebApi.Filters;
    using SilentMike.WebApi.Models;
    using SilentMike.WebApi.Services;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "SilentMike.WebApi", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "SilentMike WebApi v1"));
